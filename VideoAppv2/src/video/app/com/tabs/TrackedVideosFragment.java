 ...
 *
 */
public class TrackedVideosFragment extends SherlockFragment implements OnItemClickListener, OnMenuItemClickListener{
	
	private final String TRACKEDVIDEOS_ENDPOINT = "videos/trackedvideos?apikey=9061";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.activity_trackedvideosfragment, container, false);
	...
	private void init() {
		bar = (ProgressBar) v.findViewById(R.id.pBarAll_tracked);
		list = (GridView) v.findViewById(R.id.gvAnimalClouds_tracked);
		...
		tryAgain = (TextView) v.findViewById(R.id.tvTryAgain_tracked);
	...
	private class Task extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... arg0) {
			try {
				return iUtil.getResponse(util.getRestURL() + TRACKEDVIDEOS_ENDPOINT);
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
