 ...
 *
 */
public class RawVideosFragment extends SherlockFragment implements OnItemClickListener, OnMenuItemClickListener{
	
	private final String RAWVIDEOS_ENDPOINT = "videos/rawvideos?apikey=9061";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.activity_rawvideosfragment, container, false);
	...
	private void init() {
		bar = (ProgressBar) v.findViewById(R.id.pBarAll_raw);
		list = (GridView) v.findViewById(R.id.gvAnimalClouds_raw);
		...
		tryAgain = (TextView) v.findViewById(R.id.tvTryAgain_raw);
	...
	private class Task extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... arg0) {
			try {
				return iUtil.getResponse(util.getRestURL() + RAWVIDEOS_ENDPOINT);
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
